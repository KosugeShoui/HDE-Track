...
#                 obj['vxvy'] = [0.0, 0.0]
    ...
    # 中心座標を計算
    def bbox_sort(self,det_box):
        centers = (det_box[:, :2] + det_box[:, 2:]) / 2
        # ソート
        sorted_indices = torch.argsort(centers[:, 0])  # cxでソート
        sorted_det_box = det_box[sorted_indices]
        return sorted_det_box
    ...
    def step(self, output_results):
        ...
        if N > 0 and M > 0:
            ...
            #print(len(unmatched_dets),len(unmatched_tracks))
